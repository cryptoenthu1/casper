...
sudo apt install -y ./casper-node_0.4.0-3483_amd64.deb 
sudp apt install -y ./casper-client_0.4.0-3483_amd64.deb 
...
sed -i 's/casper-delta-6/casper-delta-7/g' bond.sh
